...
export default function SignupWizardStep7() {
      ...
      <div className="w-full max-w-lg">
        ...
        <div className="mb-12">
          <div className="flex items-center justify-between mb-3">
            <h2 className="text-sm font-medium text-gray-400">Step 7 of 7</h2>
            <div className="h-1 flex-1 mx-4 bg-[#333] rounded-full overflow-hidden">
              <div className="h-full w-full bg-gradient-to-r from-[#ff6b35] to-[#f7931e]"></div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-[#1a1a1a] rounded-lg border border-[#333] p-8">
          ...
          <div className="space-y-3">
            ...
            <button
              onClick={() => router.push('/signup-wizard/step-4')}
